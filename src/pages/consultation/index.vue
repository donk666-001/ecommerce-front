    ...
    <div class="page-wrapper">
        ...
        <main class="hub">
                ...
                <div class="hero-meta">
                    <template v-if="!isExpertView">
                        <span class="meta-item"
                            >👩‍⚕️ 入驻专家 <strong>286 位</strong></span
                        >
                        <span class="meta-item"
                            >📚 健康内容 <strong>3,420 篇</strong></span
                        >
                        <span class="meta-item"
                            >🎓 在售课程 <strong>128 门</strong></span
                        >
                        <span class="meta-item"
                            >💬 今日服务 <strong>1,256 次</strong></span
                        >
                    </template>
                    <template v-else>
                        <span class="meta-item"
                            >⏳ 待接诊
                            <strong style="color: var(--cinnabar)">{{
                                expertPendingCount
                            }}</strong></span
                        >
                        <span class="meta-item"
                            >📖 今日阅读 <strong>2,148</strong></span
                        >
                        <span class="meta-item"
                            >🎓 在售课程 <strong>5</strong></span
                        >
                        <span class="meta-item"
                            >⭐ 综合评分 <strong>4.9</strong></span
                        >
                    </template>
                </div>
            </section>
            ...
            >
                ...
                >
                    ...
                    {{ tab.label }}
                    <span v-if="tab.badge" class="role-mini">{{
                        tab.badge
                    }}</span>
                </button>
            </nav>
            ...
            <div v-show="activeTab === 'm1'" class="panel">
                <div class="space-y">
                    ...
                    <div
                        ...
                        style="border: none"
                        :style="{
                            background: solarTerm
                                ? `linear-gradient(135deg, ${solarTerm.gradientFrom} 0%, ${solarTerm.gradientTo} 100%)`
                                : 'linear-gradient(135deg, #F5EBD3 0%, #E8F0EC 100%)',
                        }"
                    >
                        <div
                            style="
                                ...
                                >
                                    ...
                                    <div class="content-info">
                                        ...
                                        <div class="content-meta">
                                            ...
                                            <span
                                                >·
                                                {{ article.reads }} 阅读</span
                                            >
                                            <span v-if="article.stars"
                                                >·
                                                {{ article.stars }} 收藏</span
                                            >
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="course-grid">
                                ...
                                >
                                    ...
                                    <div class="course-body">
                                        ...
                                        <div class="price">
                                            ¥{{ course.price }}
                                            <small v-if="course.original"
                                                >¥{{ course.original }}</small
                                            >
                                        </div>
                                    </div>
                                </div>
            ...
            <div v-show="activeTab === 'm2'" class="panel">
                ...
                <div v-if="!isLoggedIn" class="login-prompt-card">
                    ...
                    <button class="btn btn-gold" @click="router.push('/login')">
                        立即登录
                    </button>
                </div>
                <div v-else class="space-y">
                    ...
                    <div v-if="!isExpertView" class="card">
                        <div class="card-title">
                            ...
                            <span class="extra">{{
                                expertList.length > 0
                                    ? `共 ${expertList.length} 位 · 选择专家开始咨询`
                                    : "加载中…"
                            }}</span>
                        </div>
                        <div class="doctor-grid">
                            <div
                                v-for="doc in displayedExperts"
                                :key="doc.id"
                                class="doctor-card"
                            >
                                <!-- 山水背景装饰 -->
                                <svg
                                    class="doctor-mountain"
                                    viewBox="0 0 400 120"
                                    fill="none"
                                >
                                    <path
                                        d="M0 80 C60 50 90 90 150 70 C210 50 260 95 320 65 C360 45 385 70 400 55 L400 120 L0 120 Z"
                                        fill="#6f8f7b"
                                    />
                                </svg>
                                <!-- 头像（金色渐变边框环） -->
                                <div class="doctor-avatar-wrap">
                                    ...
                                    <div
                                        v-else
                                        class="doctor-avatar doctor-avatar-text"
                                    >
                                        {{ avatarText(doc) }}
                                    </div>
                                </div>
                                <!-- 姓名 -->
                                <div class="doctor-name font-serif">
                                    {{ doc.realName }}
                                </div>
                                <!-- 专家标签 -->
                                ...
                                >
                                    <span
                                        v-for="(
                                            line, idx
                                        ) in formatDoctorBioLines(doc.bio)"
                                        :key="idx"
                                        class="doctor-bio-line"
                                    >
                                        {{ line }}
                                    </span>
                                </div>
                        ...
                        <div v-else ref="chatShellRef" class="chat-shell">
                            <div class="chat-main">
                                <div class="chat-head">
                                    ...
                                    <div class="ava font-serif">
                                        {{ avatarText(selectedExpert) }}
                                    </div>
                                    <div class="who">
                                        <h4>
                                            {{ selectedExpert.realName }}
                                            {{
                                                roleLabel(
                                                    selectedExpert.roleType,
                                                )
                                            }}
                                            <span
                                                :class="
                                ...
                                <div class="chat-body" ref="chatBodyEl">
                                    <div
                                        v-for="(msg, idx) in consultMessages"
                                        :key="idx"
                                    >
                                        <div
                                            v-if="msg.kind === 'me'"
                                        ...
                                        >
                                            <div class="msg-avatar user">
                                                {{
                                                    userStore.G_LoginInfo.nickName?.charAt(
                                                        0,
                                                    ) || "我"
                                                }}
                                            </div>
                                        ...
                                        <div
                                            v-else-if="msg.kind === 'expert'"
                                            class="msg-row"
                                        >
                                            <div class="msg-avatar expert">
                                                {{ avatarText(selectedExpert) }}
                                            </div>
                                            <div class="bubble-wrap">
                                                <div class="bubble bub-user">
                                                    {{ msg.text }}
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <template v-else>
                                    <div class="chat-head">
                                        ...
                                        >
                                            {{
                                                (
                                                    currentExpertSession?.userNickname ||
                                                    "?"
                                                ).charAt(0)
                                            }}
                                        </div>
                                        <div class="who">
                                            <h4>
                                                ...
                                                {{
                                                    genderLabel(
                                                        currentExpertSession?.userGender,
                                                    )
                                                }}
                                                <span class="pill pill-jade"
                                                    >咨询中</span
                                    ...
                                    <div
                                        ...
                                        ref="expertChatBodyEl"
                                    >
                                        <div
                                            v-if="expertLoadingMessages"
                                            style="
                                                text-align: center;
                                                padding: 20px;
                                                color: var(--ink-muted);
                                        ...
                                        <template v-else>
                                            <div
                                                v-for="msg in displayedExpertMessages"
                                                :key="msg.id"
                                            >
                                                <div
                                                    v-if="
                                                ...
                                                >
                                                    ...
                                                    <dl
                                                        v-if="
                                                            currentExpertSession?.aiSummary
                                                        "
                                                    >
                                                        <dt>主诉</dt>
                                                        <dd>
                                                            {{
                                                                currentExpertSession
                                                                    .aiSummary
                                                                    .mainComplaint ||
                                                                "未提及"
                                                            }}
                                                        ...
                                                        <dd>
                                                            {{
                                                                currentExpertSession.aiSummary.symptoms?.join(
                                                                    "、",
                                                                ) || "暂无"
                                                            }}
                                                        </dd>
                                    ...
                                    <div class="chat-input">
                                        <button
                                            ...
                                            :class="{
                                                active: quickReplyPanelVisible,
                                            }"
                                            type="button"
                                            @click="
                                                quickReplyPanelVisible =
                                                    !quickReplyPanelVisible
                                            "
                                        >
                                            快捷回复
                                        ...
                                        <input
                                            type="text"
                                            v-model="expertChatInput"
                                            placeholder="输入回复内容…"
                                            @keydown.enter="sendExpertMessage"
                                        />
                                        <button
                                            class="btn btn-sm"
                                            type="button"
            ...
            <div v-show="activeTab === 'm3'" class="panel">
                <div class="space-y">
                    <div class="profile-cover">
                        ...
                        />
                        <div v-else class="ava-big">
                            {{ profileAvatarText }}
                        </div>
                        <h2>
                            {{ userStore.G_LoginInfo.nickName || "未登录" }}
                        </h2>
                        <p>
                            {{ profileRole }} · 已注册 {{ profileDays }} 天 · ID
                            {{ profileId }}
                        </p>
                    </div>
                    ...
                    <div class="stat-grid">
                        <div class="stat-cell">
                            <div class="n">12</div>
                            <div class="l">收藏内容</div>
                        </div>
                        <div class="stat-cell">
                            <div class="n">3</div>
                            <div class="l">已购课程</div>
                        </div>
                        <div class="stat-cell">
                            <div class="n">5</div>
                            <div class="l">咨询次数</div>
                        </div>
                        <div class="stat-cell">
                            <div class="n">2</div>
                            <div class="l">关注专家</div>
                        </div>
                    </div>
                    ...
                    <div v-if="isRegularUserView" class="grow-card">
                        ...
                        <p>
                            有医师 / 营养师 / 康复师 /
                            养生达人资质？加入名医健康圈，开启内容创作、课程发布与在线问诊三重通道，让专业被更多人看见。
                        </p>
                        ...
                        <button class="btn btn-gold" @click="switchTab('m4')">
                            前往认证申请 →
                        </button>
                        <span
                            style="
                                ...
                                color: var(--ink-muted);
                            "
                            >已认证？<a href="#" style="color: var(--jade)"
                                >登录专家账号</a
                            ></span
                        >
                    </div>
            ...
            <div v-show="activeTab === 'm4'" class="panel">
                <div class="space-y">
                            ...
                            <template v-else>
                                <div
                                    v-if="
                                        ...
                                        myApplication.status === 'REVIEWING'
                                    "
                                    style="text-align: center; padding: 20px 0"
                                >
                                    <div
                                ...
                                <div
                                    v-else-if="
                                        myApplication.status === 'ACTIVATED'
                                    "
                                    style="text-align: center; padding: 20px 0"
                                >
                                    <div
                    ...
                    <template v-if="myApplication?.status === 'REJECTED'">
                        <div
                            class="card"
                            style="border-left: 3px solid var(--cinnabar)"
                        >
                            <div class="card-title">
                                <span
                                    class="dot"
                            ...
                            <div
                                v-if="myApplication.rejectSuggestion"
                                style="
                                    color: var(--ink-muted);
                                    font-size: 13px;
                                    margin-bottom: 16px;
                    ...
                    <template v-if="m4ShowForm">
                        ...
                        <div class="card">
                            <div class="card-title">
                                <span class="dot"></span>选择入驻角色
                            </div>
                            <div class="role-grid">
                                <div
                                    v-for="(role, idx) in certRoles"
                                    :key="role.roleType"
                                    class="role-card"
                                    :class="{ active: m4RoleIdx === idx }"
                                    @click="
                                        m4RoleIdx = idx;
                                        m4Attachments = {};
                                    "
                        ...
                        <div class="card">
                            ...
                            <div class="upload-grid">
                                <div
                                    ...
                                    class="upload-slot"
                                    :class="{
                                        done: !!m4Attachments[slot.docType],
                                    }"
                                    @click="
                                        fileInputRefs[slot.docType]?.click()
                                    "
                                >
                                    <input
                                        :ref="
                                            (el) =>
                                                (fileInputRefs[slot.docType] =
                                    ...
                                    <span class="ico">
                                        {{
                                            m4Uploading[slot.docType]
                                                ? "⏳"
                                                : m4Attachments[slot.docType]
                                                  ? "✓"
                                                  : "＋"
                                        }}
                                    </span>
            ...
            <div v-show="activeTab === 'm5'" class="panel">
                <div class="space-y">
                    <div class="expert-hero">
                        <div class="greet">
                            {{ expertDoctorName }}，{{ timeGreeting() }}
                        </div>
                        <div class="greet-sub">
                            {{ solarTerm?.name ?? "立夏" }} · 阳气方盛 ·
                            今日为您匹配了 {{ expertPendingCount }} 位待接诊用户
                        </div>
                        <div class="expert-stats">
                            <div class="expert-stat urgent">
                                <div class="n">{{ expertPendingCount }}</div>
                                <div class="l">⏳ 待接诊（请求转人工）</div>
                            </div>
                            <div class="expert-stat">
                                <div class="n">2.1k</div>
                                <div class="l">📖 今日内容阅读</div>
                            </div>
                            <div class="expert-stat">
                                <div class="n">5</div>
                                <div class="l">🎓 在售课程</div>
                            </div>
                            <div class="expert-stat">
                                <div class="n">4.9</div>
                                <div class="l">⭐ 综合服务评分</div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="work-list">
                                ...
                                <div class="work-row rejected">
                                    ...
                                    <div class="actions">
                                        <button class="btn btn-cinnabar btn-sm">
                                            修改重提
                                        </button>
                                    </div>
                                </div>
        ...
        >
            ...
            <div class="toast-copy">
                ...
                <div v-if="toastDetail" class="toast-detail">
                    {{ toastDetail }}
                </div>
            </div>
        </div>
        ...
        <Teleport to="body">
            <div
                v-if="showQueueDialog"
                class="queue-dialog-overlay"
                @click.self="showQueueDialog = false"
            >
            ...
            <div v-if="showExpertModal" class="expert-modal-overlay">
                <div class="expert-modal">
                    ...
                    <div class="expert-modal-header">
                        <button
                            class="expert-modal-back"
                            @click="showExpertModal = false"
                        >
                            ← 返回
                        </button>
                        <span class="expert-modal-title font-serif"
                            >全部专家 · {{ expertList.length }} 位</span
                        >
                    </div>
                    <!-- 职称筛选 Tab -->
                    <div class="expert-filter-bar">
                        <button
                            ...
                            :class="[
                                'expert-filter-tab',
                                { active: activeRoleFilter === tab.key },
                            ]"
                    ...
                    <div class="expert-modal-body">
                        <div
                            v-if="filteredModalExperts.length > 0"
                            class="doctor-grid"
                        >
                            <div
                                v-for="doc in filteredModalExperts"
                                :key="doc.id"
                                class="doctor-card"
                            >
                                <svg
                                ...
                                <button
                                    class="doctor-consult-btn"
                                    @click.stop="startConsultFromModal(doc)"
                                >
                                    向TA咨询 ›
                                </button>
                            </div>
        ...
        <Teleport to="body">
            ...
            >
                ...
                >
                    <div class="withdraw-dialog__glow"></div>
                    <div class="withdraw-dialog__header">
                        <div>
                            <div class="withdraw-dialog__kicker">
                                APPLICATION STATUS
                            </div>
                            <h3
                    ...
                    <div class="withdraw-dialog__body">
                        <div class="withdraw-dialog__icon">!</div>
                        <div class="withdraw-dialog__content">
                            <p
                                id="withdraw-dialog-desc"
                                class="withdraw-dialog__desc"
                            >
                                撤回后将结束当前审核流程，之后需要重新提交资料才能再次申请。
                            </p>
                            <div class="withdraw-dialog__note">
                                当前认证进度会被清空，建议确认资料需要调整后再执行撤回。
                            </div>
                        </div>
                    </div>
            ...
            <div v-if="showSignContractDialog" class="contract-dialog-overlay">
                <div class="contract-dialog">
                    <div class="contract-dialog-header">
                        <div>
                            <div class="contract-kicker">
                                EXPERT SERVICE AGREEMENT
                            </div>
                            <h3 class="font-serif">颐养阁专家入驻服务协议</h3>
                        </div>
                        <button
                            class="contract-close"
                            :disabled="m4Signing"
                            aria-label="关闭协议"
                            @click="m4DeclineContract"
                        >
                            ×
                        </button>
                    </div>
                    ...
                    >
                        ...
                        <p>
                            乙方已提交专家认证资料并通过平台审核。为明确双方权利义务，甲乙双方就乙方入驻颐养阁名医健康圈并提供健康咨询、内容创作、课程服务、用户互动及平台后续开放的专家服务事项，达成如下模拟协议：
                        </p>

                        <h4>一、定义与适用范围</h4>
                        <p>
                            本协议所称“平台”指颐养阁及其运营的名医健康圈相关产品、页面、接口与服务；“专家服务”指乙方基于自身专业背景向用户提供的健康科普、咨询答疑、课程内容、训练建议、生活方式建议及平台认可的其他服务。
                        </p>
                        <p>
                            本协议为专家入驻开通阶段的模拟签约文本，用于当前业务流程联调和功能演示。正式上线前，平台可根据法律法规、业务规则和合规审查结果更新协议版本。
                        </p>

                        <h4>二、入驻身份与服务内容</h4>
                        <p>
                            乙方同意以认证专家身份入驻平台，并在审核通过的角色类型及专业资质范围内提供服务。乙方应确保服务内容与自身认证类型相匹配，不得借平台名义从事与认证资质无关的经营活动。
                        </p>
                        <p>
                            乙方可在平台内发布健康科普文章、录制或发布课程、参与在线咨询、维护个人主页、响应用户转人工咨询请求，并使用平台为专家开放的数据看板、收益结算、内容管理等功能。
                        </p>
                        <p>
                            乙方不得超出线上健康咨询和科普边界进行诊断、处方、开具医学证明、承诺疗效或替代线下医疗机构诊疗。用户存在急危重症、疑似重大疾病、持续恶化症状或明确需要线下检查时，乙方应提示用户及时就医。
                        </p>

                        <h4>三、资料真实性与持续合规</h4>
                        <p>
                            乙方承诺其提交的身份信息、资质证书、执业证明、学历证明、作品材料、从业经历及联系方式均真实、合法、有效，不存在伪造、冒用、篡改、过期、被吊销或被限制执业等情形。
                        </p>
                        <p>
                            乙方资料发生变更、证书到期、执业状态变化、联系方式变化或出现可能影响专家服务资格的情况时，应及时在平台更新资料并配合复核。平台有权基于风控、投诉、监管要求或内部审核需要，要求乙方补充材料或重新认证。
                        </p>

                        <h4>四、服务行为规范</h4>
                        <p>
                            乙方应遵守法律法规、平台规则、医学伦理和职业道德，以专业、审慎、真实、友善的方式服务用户。乙方应避免使用恐吓性、绝对化、诱导性或夸大宣传语言。
                        </p>
                        <p>
                            乙方不得发布虚假健康信息、违法广告、违规医疗宣传、违禁药品或器械推广内容，不得诱导用户脱离平台私下交易，不得向用户索要与服务无关的敏感个人信息。
                        </p>
                        <p>
                            乙方应尊重用户隐私，不得泄露、出售、传播、截图公开或以其他方式不当使用用户咨询内容、健康信息、联系方式、身份信息及平台数据。
                        </p>

                        <h4>五、内容与知识产权</h4>
                        <p>
                            乙方在平台发布的原创内容，其著作权归乙方或合法权利人所有。乙方授权平台在服务展示、推荐分发、运营推广、审核存档、用户服务和纠纷处理范围内使用相关内容。
                        </p>
                        <p>
                            乙方应保证发布内容不侵犯第三方知识产权、肖像权、名誉权、隐私权或其他合法权益。涉及引用、转载、合作内容或第三方素材时，乙方应确保已取得合法授权或符合合理使用要求。
                        </p>

                        <h4>六、平台审核与权限开通</h4>
                        <p>
                            乙方点击“同意并签约”后，视为乙方已完整阅读、理解并接受本协议。平台将立即为乙方开通专家权限，并同步刷新乙方账号角色。开通后，乙方可进入专家工作台处理咨询、发布内容或使用平台后续开放的专家功能。
                        </p>
                        <p>
                            平台有权对乙方发布内容、服务记录、用户投诉、资质状态及异常行为进行审核。审核不代表平台对乙方服务结果作出保证，也不免除乙方应自行承担的专业责任与合规责任。
                        </p>

                        <h4>七、收益与结算</h4>
                        <p>
                            如平台开放付费咨询、课程售卖、内容分成或其他收益能力，乙方收益以平台届时展示的结算规则、订单记录和实际到账数据为准。平台可根据退款、投诉、违规处理、税费扣缴、渠道手续费等因素进行结算调整。
                        </p>
                        <p>
                            乙方应确保收款账户、实名信息及税务资料真实有效。因乙方资料错误、账户异常或违反规则导致无法结算、延迟结算或被扣回款项的，乙方自行承担相应后果。
                        </p>

                        <h4>八、数据安全与用户隐私</h4>
                        <p>
                            平台将根据业务需要处理专家认证材料、服务记录、用户咨询记录、消息通知、登录状态和角色权限等数据。乙方应合理使用平台提供的数据，不得通过爬取、批量导出、截图传播、倒卖或其他方式不当获取和使用平台数据。
                        </p>
                        <p>
                            乙方因提供服务接触到的用户健康信息、咨询内容、身份资料等均属于敏感信息，乙方应严格保密。未经用户或平台授权，乙方不得将相关信息用于本协议之外的目的。
                        </p>

                        <h4>九、违约处理</h4>
                        <p>
                            如乙方存在虚假认证、超范围服务、违规宣传、诱导私下交易、泄露用户隐私、恶意刷单、服务态度恶劣、侵犯第三方权益或其他违反法律法规及平台规则的行为，平台有权采取提醒整改、限制功能、下架内容、暂停接单、扣减收益、终止专家权限等处理措施。
                        </p>
                        <p>
                            如乙方行为造成用户、平台或第三方损失，乙方应依法承担相应责任。平台因配合监管、处理投诉、维护平台安全或保护用户权益而采取必要措施的，不视为违约。
                        </p>

                        <h4>十、协议变更、退出与终止</h4>
                        <p>
                            平台可根据法律法规、监管要求、业务调整或风控需要更新本协议及相关规则，并通过站内通知、页面提示或其他合理方式告知乙方。乙方继续使用专家服务功能的，视为接受更新后的协议。
                        </p>
                        <p>
                            乙方可按平台规则申请退出专家身份。退出前已发生的订单、咨询、课程交付、售后、投诉处理、结算义务和保密义务仍应继续履行。平台因乙方违规或资质失效终止专家权限的，可保留必要记录用于审计和纠纷处理。
                        </p>

                        <h4>十一、免责声明</h4>
                        <p>
                            平台提供信息展示、技术连接、在线互动和服务管理能力，不对乙方的专业结论、服务效果或用户采纳建议后的结果作出绝对保证。乙方应基于专业判断独立、审慎地提供服务。
                        </p>
                        <p>
                            因不可抗力、网络故障、第三方服务异常、监管要求、系统维护或用户自身原因导致服务中断、延迟、数据展示异常的，平台将在合理范围内协助处理。
                        </p>

                        <h4>十二、确认与生效</h4>
                        <p>
                            乙方确认，已充分阅读并理解本协议全部条款，特别是服务边界、资料真实性、隐私保护、违规处理、收益结算和免责声明等内容。乙方点击“同意并签约”即表示本协议生效，并同意平台为其开通专家权限。
                        </p>
                    </div>

                    <div class="contract-confirm">
                        <span v-if="contractScrolledToEnd"
                            >已阅读完整协议，可以选择是否签约。</span
                        >
                        <span v-else
                            >请向下滚动并阅读完整协议后，才可点击“同意并签约”。</span
                        >
                    </div>
                    ...
                    <div class="contract-actions">
                        ...
                        <button
                            class="btn btn-gold"
                            :disabled="m4Signing || !contractScrolledToEnd"
                            @click="m4AgreeSignContract"
                        >
                            {{
                                m4Signing
                                    ? "签约开通中..."
...
const heroTitle = computed(() =>
    isExpertView.value ? "专家工作台 · 名医健康圈" : "名医健康圈",
);
...
/** 移除 AI 回复中的 Markdown 格式标记，输出纯文本 */
...
function applyRequestedEntryTab() {
    const requestedTab =
    ...
    const matchedTab = visibleTabs.value.find(
        (tab) => tab.name === requestedTab,
    );
    if (matchedTab) {
...
const { subscribe: subscribeOnline, unsubscribe: unsubscribeOnline } =
    useExpertOnlineSocket();
...
function onStompMessage(frame: any) {
    ...
    if (event === "consult.ai_message") {
        ...
        consultMessages.value.push({
            kind: "sys",
            text: "✓ AI 预问诊小结已生成，等待医生接入…",
            success: true,
        });
        consultMessages.value.push({
            kind: "sys",
            text: "⏳ 转人工请求已发送，等待医生接入…",
        });
...
async function startConsult(doc: ExpertCardDTO) {
    ...
    nextTick(() => {
        chatShellRef.value?.scrollIntoView({
            behavior: "smooth",
            block: "start",
        });
    });
...
const roleFilterTabs = computed(() => {
    ...
    const tabs = [
        { key: "ALL", label: "全部", count: expertList.value.length },
    ];
    present.forEach((r) => {
        tabs.push({
            key: r,
...
function avatarUrl(expert: ExpertCardDTO) {
    return expert.avatar?.trim() ? expert.avatar : null;
}
...
const articles = [
    ...
    {
        title: "3 分钟学会·缓解经期腹痛的穴位按摩",
        author: "李清和",
        tag: "短视频",
        tagClass: "pill-cinnabar",
        emoji: "🎥",
        reads: "1.5w",
        coverBg:
    ...
    {
        title: "问答 · 长期熬夜的人，应该怎么喝茶？",
        author: "周一谦",
        tag: "问答",
        tagClass: "pill-bamboo",
        emoji: "🍵",
        reads: "3.4k",
        coverBg:
            "background:linear-gradient(135deg,var(--bamboo-soft),var(--jade-soft));",
    },
];
...
const courses = [
    {
        title: "21 天体质辨识与调理",
        emoji: "🌿",
        bg: "linear-gradient(135deg,var(--jade-soft),var(--pink-soft))",
        badge: "爆款",
        author: "张景行 · 21 课时",
        price: "199",
        original: "299",
    },
    {
        title: "四季药膳实战课",
        emoji: "🍲",
        bg: "linear-gradient(135deg,var(--gold-soft),var(--pink-soft))",
        badge: "",
        author: "周一谦 · 24 课时",
        price: "299",
        original: "",
    },
    {
        title: "八段锦零基础入门",
        emoji: "🧘",
        bg: "linear-gradient(135deg,var(--jade-soft),var(--bamboo-soft))",
        badge: "",
        author: "王师傅 · 8 课时",
        price: "99",
        original: "",
    },
    {
        title: "女性月经调理 30 讲",
        emoji: "💆",
        bg: "linear-gradient(135deg,var(--pink-soft),var(--jade-soft))",
        badge: "",
        author: "李清和 · 30 课时",
        price: "399",
        original: "",
...
watch(
    ...
    (roleId) => {
        consultView.value = roleId === 2 ? "expert" : "user";
    },
    { immediate: true },
);
...
const defaultQuickReplies: QuickReplyItem[] = [
    {
        id: "greet",
        content: "您好，我已经接入本次咨询，请先告诉我您目前最明显的不适。",
    },
    { id: "temp", content: "请先测量一下体温，并告诉我最高体温和持续时间。" },
    {
        id: "history",
        content: "请问症状出现多久了？之前有没有类似情况或基础疾病？",
    },
    {
        id: "advice",
        content: "收到，我先为您整理情况，请稍等，我马上给您建议。",
    },
];
...
const currentExpertSession = computed(() =>
    expertSessionId.value
        ? (pendingList.value.find(
              (i) => i.sessionId === expertSessionId.value,
          ) ??
...
const displayedExpertMessages = computed(() => {
    ...
    return expertMessages.value
        ...
        .map((msg) => {
            // 对 AI 文本消息剥离 Markdown 格式
            if (
                msg.senderType === "ai" &&
                msg.contentType === "text" &&
                msg.content
            ) {
                return { ...msg, content: stripMarkdownForDisplay(msg.content) };
            }
            return msg;
        });
});
    ...
    try {
        ...
        nextTick(() => {
            if (expertChatBodyEl.value) {
                expertChatBodyEl.value.scrollTop =
                    expertChatBodyEl.value.scrollHeight;
            }
        });
    }
    const { connect } = useConsultSocket();
    ...
    try {
        ...
        if (data) {
            ...
            if (data.status === "HUMAN_CHATTING") {
                const idx = pendingList.value.findIndex(
                    (i) => i.sessionId === expertSessionId.value,
                );
                if (idx !== -1) {
                    const item = {
                        ...pendingList.value[idx],
                        status: "HUMAN_CHATTING" as const,
                    };
...
const { subscribe: subscribeExpertQueue, unsubscribe: unsubscribeExpertQueue } =
    useExpertQueueSocket();
...
// 各角色附件 slot 定义
const roleSlotMap: Record<
    string,
    { docType: string; label: string; hint: string; optional: boolean }[]
> = {
    DOCTOR: [
        {
            docType: "id_card_front",
            label: "身份证人像面",
            hint: "jpg/png/pdf · ≤5MB",
            optional: false,
        },
        {
...
const expertRealName = computed(
    () => expertProfile.value?.realName?.trim() || "",
);
const expertDoctorName = computed(() => {
    const realName = expertRealName.value.replace(/\s+/g, "");
    if (realName) {
        const compoundSurname = COMPOUND_SURNAMES.find((surname) =>
            realName.startsWith(surname),
        );
...
async function m4Submit() {
    ...
    if (!m4RealName.value.trim()) {
        alert("请填写真实姓名");
        return;
    }
    if (m4Bio.value.trim().length < 10) {
        alert("个人简介至少 10 个字");
        return;
    }
    // 检查必填附件是否已上传
    ...
    const missingSlots = requiredSlots.filter(
        (s) => !m4Attachments.value[s.docType],
    );
...
function m4Withdraw() {
    if (!myApplication.value?.id || m4Withdrawing.value) return;
    showWithdrawDialog.value = true;
}

function closeWithdrawDialog() {
    if (m4Withdrawing.value) return;
    showWithdrawDialog.value = false;
}

async function confirmWithdraw() {
    const applicationId = myApplication.value?.id;
    ...
    try {
        ...
        myApplication.value = null;
        showWithdrawDialog.value = false;
        toast("申请已撤回", "您可以调整资料后重新提交认证申请。", "success");
    } catch {
...
.pill-gray {
    background: var(--ink-soft, #e5e7eb);
...
.doctor-card::before {
    ...
    background:
        radial-gradient(
            circle at top left,
            rgba(117, 144, 122, 0.07),
            transparent 35%
        ),
        radial-gradient(
            circle at bottom right,
            rgba(117, 144, 122, 0.05),
            transparent 35%
        );
}
...
.doctor-tag {
    ...
    font-size: 11px;
    letter-spacing: 2px;
    box-shadow: 0 4px 10px rgba(188, 64, 64, 0.2);
    position: relative;
    z-index: 1;
}
...
.doctor-bio {
    ...
    width: var(--doctor-content-width);
    max-width: 100%;
    margin: 0 auto;
    padding: 0 2px;
    text-align: center;
...
.doctor-consult-btn {
    ...
    font-family: inherit;
    transition: all 0.3s;
    box-shadow: 0 8px 18px rgba(93, 124, 105, 0.22);
    position: relative;
    z-index: 1;
}
.doctor-consult-btn:hover {
    transform: translateY(-2px);
    box-shadow: 0 14px 24px rgba(93, 124, 105, 0.32);
}
...
.expert-filter-tab:hover:not(.active) {
    border-color: var(--jade);
    color: var(--jade);
}
...
.contract-body::-webkit-scrollbar-thumb {
    background: linear-gradient(
        180deg,
        rgba(111, 143, 123, 0.58),
        rgba(180, 136, 74, 0.48)
    );
    border-radius: 999px;
...
.contract-body::-webkit-scrollbar-thumb:hover {
    background: linear-gradient(
        180deg,
        rgba(111, 143, 123, 0.78),
        rgba(180, 136, 74, 0.64)
    );
}
...
.withdraw-dialog {
    ...
    background:
        linear-gradient(
            ...
            rgba(255, 248, 236, 0.94) 18%,
            var(--paper) 44%
        );
    border-radius: 20px;
    border: 1px solid rgba(232, 223, 208, 0.88);
    box-shadow: 0 24px 72px rgba(42, 38, 31, 0.24);
    overflow: hidden;
    animation: modalSlideIn 0.3s cubic-bezier(0.22, 0.61, 0.36, 1);
}
.withdraw-dialog__glow {
    position: absolute;
    top: -88px;
    right: -32px;
    width: 220px;
    ...
    background: radial-gradient(
        circle,
        rgba(220, 171, 55, 0.24) 0%,
        rgba(220, 171, 55, 0) 70%
    );
    pointer-events: none;
}
...
.withdraw-dialog__close:hover:not(:disabled) {
    background: var(--cinnabar-soft);
    border-color: rgba(179, 60, 44, 0.24);
    color: var(--cinnabar);
}
.withdraw-dialog__close:disabled {
    opacity: 0.55;
    cursor: not-allowed;
}
...
.withdraw-dialog__icon {
    width: 48px;
    height: 48px;
    border-radius: 16px;
    background: linear-gradient(135deg, #f4c15d 0%, #e39c2d 100%);
    color: white;
    font-size: 28px;
    font-weight: 700;
    display: flex;
    align-items: center;
    justify-content: center;
    box-shadow: 0 12px 28px rgba(227, 156, 45, 0.28);
    flex-shrink: 0;
}
.withdraw-dialog__content {
    flex: 1;
}
.withdraw-dialog__desc {
    margin: 0;
    color: var(--ink);
    font-size: 15px;
    line-height: 1.9;
...
.withdraw-dialog__note {
    ...
    background: linear-gradient(
        135deg,
        rgba(250, 239, 215, 0.9) 0%,
        rgba(240, 248, 242, 0.95) 100%
    );
    border: 1px solid rgba(220, 171, 55, 0.22);
    color: var(--ink-muted);
    font-size: 12px;
    line-height: 1.7;
}
...
.withdraw-dialog__actions .btn-ghost:disabled:hover {
    background: transparent;
    color: var(--jade);
}
.withdraw-dialog__actions .btn-cinnabar:disabled:hover {
    background: var(--cinnabar);
    color: white;
}
...
.course-thumb {
    height: 110px;
    background: linear-gradient(135deg, var(--jade-soft), var(--pink-soft));
    display: flex;
    align-items: center;
    justify-content: center;
    font-size: 44px;
...
.chat-head .ava {
    ...
    height: 44px;
    border-radius: 50%;
    background: linear-gradient(135deg, var(--jade), var(--bamboo));
    color: white;
    display: flex;
    align-items: center;
    justify-content: center;
...
.handoff-chip {
    background: var(--cinnabar-soft);
    color: var(--cinnabar);
    border: 1px solid rgba(179, 60, 44, 0.25);
    border-radius: 16px;
    padding: 7px 14px;
    font-size: 12px;
    cursor: pointer;
...
.quick-reply-editor input:focus {
    border-color: var(--jade);
}
...
.archive-list .ar-row span:first-child {
    color: var(--ink-muted);
}
.archive-list .ar-row span:last-child {
    color: var(--ink);
    font-weight: 500;
}
.side-section {
...
.switch-row.off .toggle {
    background: var(--line);
}
.switch-row.off .toggle::after {
    left: 2px;
    right: auto;
}
...
.upload-slot .req-tag.optional {
    background: var(--gold-soft);
    color: var(--gold-deep);
}
.upload-slot.done .req-tag {
    background: var(--bamboo);
    color: white;
}
.upload-slot.done .req-tag.optional {
    background: var(--bamboo);
}
...
.work-row.review .thumb {
    background: var(--gold-soft);
    color: var(--gold-deep);
}
.work-row.rejected .thumb {
    background: var(--cinnabar-soft);
    color: var(--cinnabar);
}
.work-row .info {
