        ...
        <main class="hub">
            ...
            <section class="hero">
                <div class="hero-text">
                    ...
                    <p class="hero-sub">
                        小荷，立夏快乐 ☀️ 我可以帮你<strong
                            style="color: var(--jade)"
                            >答养生疑问、做个性化计划、推荐适合的好物</strong
                        >
                        —— 在同一段对话里都能完成。
                    </p>
                </div>
                <div class="hero-meta">
                    ...
                    <span class="meta-item"
                        >🌿 计划 <strong>第 14 / 30 天</strong></span
                    >
                    <span class="meta-item"
                        >⭐ 完成率 <strong>78%</strong></span
                    >
                </div>
            </section>
            ...
            <div class="chat-app">
                ...
                <aside class="side">
                    ...
                    <div class="side-section">
                        ...
                        <div class="cap-item reco">
                            ...
                            <div class="desc">
                                综合体质 / 节气 / 计划三维度选品并解释理由
                            </div>
                            <button
                                class="example"
                                @click="send('推荐一些适合江南体质的养心好物')"
                            >
                                🛒 推荐养心好物
                            </button>
                        </div>
                    ...
                    <div class="side-section">
                        ...
                        <div
                            class="profile-chip"
                            @click="toast('⚙ 打开偏好设置抽屉（演示）')"
                        >
                            <div class="prow">
                                <span>体质</span><span>江南 · 气虚偏湿</span>
                            </div>
                            <div class="prow">
                                <span>目标</span><span>养心 · 祛湿</span>
                            </div>
                            <div class="prow">
                                <span>过敏</span><span>花生 · 芒果</span>
                            </div>
                            <div class="prow">
                                <span>所在地</span><span>江浙</span>
                            </div>
                    ...
                    <div class="side-section">
                        ...
                        <div class="history-list">
                            ...
                            <div
                                class="history-item"
                                :class="{ active: activeHistory === 0 }"
                                @click="activeHistory = 0"
                            >
                                <h6>立夏养心 + 7 天计划</h6>
                            ...
                            <div
                                class="history-item"
                                :class="{ active: activeHistory === 1 }"
                                @click="activeHistory = 1"
                            >
                                <h6>气虚体质能吃当归吗</h6>
                            ...
                            <div
                                class="history-item"
                                :class="{ active: activeHistory === 2 }"
                                @click="activeHistory = 2"
                            >
                                <h6>湿气重怎么调理</h6>
                            ...
                            <div
                                class="history-item"
                                :class="{ active: activeHistory === 3 }"
                                @click="activeHistory = 3"
                            >
                                <h6>八段锦哪一式护肝</h6>
                            ...
                            <div
                                class="history-item"
                                :class="{ active: activeHistory === 4 }"
                                @click="activeHistory = 4"
                            >
                                <h6>夏天泡什么茶最养生</h6>
                ...
                <div class="main">
                        ...
                        <template v-if="!isNewChat">
                            ...
                            <div class="msg-row">
                                ...
                                <div class="bubble-wrap">
                                    ...
                                    <div class="bubble bub-ai">
                                        立夏时节人体心阳偏旺。结合你的<strong
                                            style="color: var(--jade)"
                                            >江南体质（气虚偏湿）</strong
                                        >，养心建议从这三方面：<br /><br />
                                        <strong>① 饮食</strong
                                        >：清淡、多吃红色养心食材（红豆、桂圆、莲子），少吃生冷油腻。<br />
                                        <strong>② 作息</strong>：晚睡早起（22:30
                                        - 06:30），中午小憩 20 分钟养心阳。<br />
                                        <strong>③ 运动</strong
                                        >：避免大汗淋漓，推荐八段锦、太极、傍晚散步。
                                    ...
                                    <div class="msg-actions">
                                        ...
                                        <button
                                            class="msg-action"
                                            @click="toast('已收到，AI 会改进')"
                                        >
                                            👎
                                        </button>
                                        <button
                                            class="msg-action"
                                            @click="toast('🔄 AI 重新生成中…')"
                                        >
                                            🔄 换一种说法
                                        </button>
                                        <button
                            ...
                            <div class="msg-row">
                                ...
                                <div class="bubble-wrap">
                                    ...
                                    >
                                    <div class="bubble bub-ai">
                                        胸闷可能与多种原因有关，<strong>具体诊断需由专业医师判断</strong>。AI
                                        不作医疗结论，但我可以帮你直接转到名医健康圈，由医师团队的
                                        AI 先做预问诊：
                                        <div class="handoff-card">
                                            <h6>🩺 该问题建议向医师咨询</h6>
                                            <p>
                                                胸闷涉及心血管判断。你可以前往「名医健康圈」向擅长该方向的医师咨询，医师那一侧会有专属
                                                AI 先帮你预问诊。
                                            </p>
                                            <button
                                                class="handoff-btn"
                    ...
                    <div class="quick-prompts">
                        ...
                        <button
                            class="quick-prompt"
                            @click="send('推荐适合气虚体质的药材')"
                        >
                            <span class="tagico">🛒</span> 推荐适合的药材
                        </button>
                        <button
                            class="quick-prompt"
                            @click="send('夏季失眠怎么调理')"
                        ...
                        <button
                            ...
                            @click="send('孩子积食怎么按摩')"
                        >
                            <span class="tagico">💬</span> 小儿积食
                        </button>
                        <button
                            class="quick-prompt"
                            @click="send('给我推荐节气养生礼盒')"
                        >
                            <span class="tagico">🛒</span> 节气礼盒
                        </button>
                    </div>
                    ...
                    <div class="chat-input-wrap">
                        <div class="chat-input-row">
                            ...
                            <input
                                type="text"
                                v-model="chatInput"
                                placeholder="问养生问题 / 让 AI 做计划 / 让 AI 推荐商品 —— 都在这里说"
                                @keydown.enter="send()"
                            />
                            <button
                                class="icon-btn"
...
.profile-chip .prow span:first-child {
    color: var(--ink-muted);
}
.profile-chip .edit {
    text-align: center;
...
.citation-card .info h6 {
    font-size: 12px;
    color: var(--ink);
    margin-bottom: 2px;
}
.citation-card .info .meta {
    font-size: 11px;
    color: var(--ink-muted);
}
.citation-card .arrow {
...
.artifact-actions .btn-sm:hover {
    background: var(--ink);
}
.artifact-actions .btn-sm.ghost {
    background: transparent;
    border: 1px solid var(--jade);
    color: var(--jade);
}
.artifact-actions .btn-sm.ghost:hover {
    background: var(--jade-soft);
}
.artifact-actions .btn-sm.gold {
