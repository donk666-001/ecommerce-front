...
const features = [
    {
        icon: "🌿",
        name: "节气养生",
        desc: "根据当前节气推送饮食、作息、经络调理建议，顺时而为。",
        tags: ["饮食推荐", "作息指南"],
    },
    {
        icon: "🌙",
        name: "睡眠作息",
        desc: "记录睡眠质量，AI分析规律，给出个性化改善建议。",
        tags: ["睡眠追踪", "AI分析"],
    },
    {
        icon: "🌸",
        name: "经期管理",
        desc: "智能预测经期，根据不同阶段推送养生建议。",
        tags: ["周期预测", "阶段养生"],
    },
    {
        icon: "🍵",
        name: "中医养生",
        desc: "九大体质辨识，推荐食疗、穴位与中药茶饮方案。",
        tags: ["体质辨识", "食疗方案"],
    },
    {
        icon: "🫂",
        name: "情绪疗愈",
        desc: "冥想引导、情绪日记与正念练习，找回内心平静。",
        tags: ["冥想引导", "正念练习"],
    },
    {
        icon: "✨",
        name: "个性推荐",
        desc: "AI管家综合多维数据，每日生成专属养生日历。",
        tags: ["AI定制", "每日日历"],
    },
];
</script>
