      ...
      <div class="logistics-detail">
        <div class="logistics-detail-header">
          <div class="carrier">
            ...
            <span>{{ logisticsDetail.logisticsCompany || "物流公司" }}</span>
          </div>
          <div class="track-no">
            运单号：<span>{{ logisticsDetail.trackingNo || "暂无" }}</span>
          </div>
          <div class="track-status">
            当前状态：<span
              :class="getLogisticsStatusClass(logisticsDetail.status)"
            >{{ getLogisticsStatusText(logisticsDetail.status) }}</span>
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            <span class="step-time">{{ formatLogisticsTime(detail.time) }}</span>
          </div>
        </div>
        ...
        >
          ...
          >{{ logisticsDetail.currentLocation }}</span>
        </div>
      </div>
    </div>
  </div>
