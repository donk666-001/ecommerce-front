...
const agents = ref<Agent[]>([
  ...
  { account:'CS005', name:'松风', role:'presale',  maxLoad:8, currentLoad:0, status:'online', todayServed:8,  todayMsgs:65,  joinedAt:'2026-05-20', welcome:'您好，这边是颐养阁官方客服，很高兴为您服务～', workHours:'09:00-18:00' },
])
...
.modal-body input, .modal-body textarea, .modal-body select { width:100%; padding:10px 12px; border:1px solid var(--line); border-radius:7px; font-family:inherit; font-size:14px; color:var(--ink); outline:none; box-sizing:border-box; }
